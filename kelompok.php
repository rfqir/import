                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr class="parentRow"> <!-- Add a class for parent rows -->
                                            ...
                                            ?>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?= $track['admin']; ?></span>
                                            </td>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?= $track['picking']; ?></span>
                                            </td>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?= $track['box']; ?></span>
                                            </td>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?= $track['checking']; ?></span>
                                            </td>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?= $track['packing']; ?></span>
                                            </td>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?= $track['dikurir']; ?></span>
                                            </td>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?= $track['refaund']; ?></span>
                                            </td>
